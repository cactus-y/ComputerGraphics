...
def main():
    ...
    red_right = Node(base, glm.translate(glm.vec3(.2, 0, .01)), glm.translate((.25,0,.01)) * glm.scale((0.25, 0.1, 0)), glm.vec3(1,0,0))
    green_right = Node(red_right, glm.translate(glm.vec3(.50, 0, .02)), glm.translate(glm.vec3(.25, 0, .02)) * glm.scale((.25, 0.1, 0.)), glm.vec3(0,1,0))
    red_left = Node(base, glm.translate(glm.vec3(-.2, 0, .01)), glm.translate((-.25,0,.01)) * glm.scale((0.25, 0.1, 0)), glm.vec3(1,0,0))
    green_left = Node(red_left, glm.translate(glm.vec3(-.50, 0, .02)), glm.translate(glm.vec3(-.25, 0, .02)) * glm.scale((.25, 0.1, 0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        red_right.set_joint_transform(glm.rotate(t, glm.vec3(0,0,1)))
        green_right.set_joint_transform(glm.rotate(t, glm.vec3(0,0,1)))
        red_left.set_joint_transform(glm.rotate(-t, glm.vec3(0,0,1)))
        green_left.set_joint_transform(glm.rotate(-t, glm.vec3(0,0,1)))
        ...
        draw_node(vao_box, red_right, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, red_left, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, green_right, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, green_left, P*V, MVP_loc_box, color_loc_box)
