...
def main():
    ...
    window = glfwCreateWindow(800, 800, 'assignment2-rectangle', None, None)
    if not window:
        glfwTerminate()
        return
    ...
    vertices = glm.array(glm.float32,
        -0.5, 0.5, 0.0, # up-left vertex x, y, z coordinates
        -0.5, -0.5, 0.0, # down-left vertex x, y, z coordinates
        0.5, -0.5, 0.0,  # down-right vertex x, y, z coordinates
        0.5, 0.5, 0.0, # up-right vertex x, y, z coordinates
    )
