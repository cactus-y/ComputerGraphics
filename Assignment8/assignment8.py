...
uniform vec3 new_light_pos;

void main()
{
    // light and material properties
    vec3 light_pos = new_light_pos;
...
def main():
    ...
    light_pos_loc = glGetUniformLocation(shader_program, 'new_light_pos')
    ...
    while not glfwWindowShouldClose(window):
        ...
        dist = glm.distance(glm.vec3(2,2,0), glm.vec3(0,0,0))
        light_pos = glm.vec3(dist*np.sin(t), 2, dist*np.cos(t))
