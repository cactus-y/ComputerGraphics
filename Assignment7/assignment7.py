...
def main():
    ...
    red_arm = Node(base, glm.vec3(.25,0.1,0.), glm.vec3(1,0,0))
    green_arm = Node(red_arm, glm.vec3(.25, 0.1, 0.), glm.vec3(0, 1, 0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        red_arm.set_transform(glm.rotate(t, glm.vec3(0,0,1)) * glm.translate(glm.vec3(.25, 0, .01)))
        green_arm.set_transform(glm.translate(glm.vec3(0.25, 0, .02)) * glm.rotate(t, glm.vec3(0,0,1)) * glm.translate(glm.vec3(.25, 0, .02)))
