...
def key_callback(window, key, scancode, action, mods):
    global g_cam_ang, g_cam_height, alpha, beta, gamma
...
def main():
    ...
    while not glfwWindowShouldClose(window):
        ...
        # ZXZ Euler angles
        ang1 = glm.radians(alpha)
        ang2 = glm.radians(beta)
        ang3 = glm.radians(gamma)
        R1 = glm.rotate(ang1, (0, 0, 1))
        R2 = glm.rotate(ang2, (1, 0, 0))
        R3 = glm.rotate(ang3, (0, 0, 1))
